...
// The serverErrorResponse() method will be used when our application
// encounters an unexpected problem at runtime.
...
// The methodNotAllowedResponse() method will be used to send a 405 Method
// Not Allowed status code and JSON response to the client.
...
func (app *application) notPermittedResponse(w http.ResponseWriter, r *http.Request) {
	message := "your user account doesn't have the necessary permissions toaccess this resource"
	app.errorResponse(w, r, http.StatusForbidden, message)
}
