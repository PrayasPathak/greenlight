...
import (
	...
	"greenlight.net/internal/jsonlog"
	"greenlight.net/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "ca3efd99fda3a0",
		"SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "c6f81c61cbe972", "SMTP password")
